...
import { LogOut, Plus, DollarSign, List } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        <header className="flex justify-between items-center mb-12 border-b border-gray-800 pb-6">
          <div>
            ...
            <p className="text-gray-400 mt-1">Manage listings and view earnings, {user?.name}</p>
          </div>
          <button
            onClick={logout}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-900/50 backdrop-blur-md border border-gray-800 p-6 rounded-2xl">
            <div className="flex items-center gap-3 mb-4 text-purple-400">
              ...
              <h2 className="text-lg font-bold text-white">Add Parking Space</h2>
            </div>
            <p className="text-gray-400 text-sm mb-6">
              Create a listing for your driveway, garage, or open lot to start earning.
            </p>
          ...
          <div className="bg-gray-900/50 backdrop-blur-md border border-gray-800 p-6 rounded-2xl">
            <div className="flex items-center gap-3 mb-4 text-purple-400">
              ...
              <h2 className="text-lg font-bold text-white">Revenue & Bookings</h2>
            </div>
            <p className="text-gray-400 text-sm mb-6">
              Track incoming reservations, adjust your hourly rates, and withdraw payout.
            </p>
